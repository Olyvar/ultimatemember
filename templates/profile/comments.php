...
<?php } else { ?>
	...
	<div class="um-profile-note"><span><?php echo esc_html( ( um_profile_id() == get_current_user_id() ) ? __('You have not made any comments.','ultimate-member') : __('This user has not made any comments.','ultimate-member') ); ?></span></div>
